...
class TDummyData {
  ...
  static final List<CategoryModel> categories = [
    ...
    CategoryModel(id: '11', name: 'Nội thất phòng ngủ', image: TImages.furnitureIcon, isFeatured: false, parentId: '2'),
    CategoryModel(id: '12', name: 'Nội thất phòng bếp', image: TImages.furnitureIcon, isFeatured: false, parentId: '2'),
    CategoryModel(id: '13', name: 'Nội thất văn phòng', image: TImages.furnitureIcon, isFeatured: false, parentId: '2'),

    CategoryModel(id: '14', name: 'Laptop', image: TImages.electronicsIcon, isFeatured: false, parentId: '3'),
    CategoryModel(id: '15', name: 'Điện thoại', image: TImages.electronicsIcon, isFeatured: false, parentId: '3'),

    CategoryModel(id: '16', name: 'Áo sơ mi', image: TImages.clothIcon, isFeatured: false, parentId: '4'),
    CategoryModel(id: '17', name: 'Áo phông', image: TImages.clothIcon, isFeatured: false, parentId: '4'),

    CategoryModel(id: '18', name: 'Thức ăn cho thú cưng', image: TImages.animalIcon, isFeatured: false, parentId: '5'),
    CategoryModel(id: '19', name: 'Dép', image: TImages.shoeIcon, isFeatured: false, parentId: '6'),
  ];
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
      ...
      description: 'Giày thể thao Jordan nổi tiếng với thiết kế năng động và phong cách, phù hợp cho cả hoạt động thể thao và thời trang.',
      brand: BrandModel(id: '8', image: TImages.jordanLogo, name: 'Jordan', productsCount: 80, isFeatured: true),
      images: [],
      salePrice: 140,
      sku: 'JORD001',
      categoryId: '15',
      productAttributes: [
        ProductAttributeModel(name: 'Màu', values: ['Black', 'White', 'Red', 'Blue','Orange']),
        ProductAttributeModel(name: 'Size', values: ['39', '40', '41', '42', '43', '44']),
      ],
      productVariations: [
        ProductVariationModel(
          id: '1',
          ...
          description: 'Giày Jordan màu đen, size 39.',
          attributeValues: {'Màu': 'Black', 'Size': '39'},
        ),
        ProductVariationModel(
          id: '2',
          stock: 15,
          ...
          description: 'Giày Jordan màu trắng, size 40.',
          attributeValues: {'Màu': 'White', 'Size': '40'},
        ),
        ProductVariationModel(
          id: '3',
          stock: 25,
          price: 150,
          image: TImages.productImage7,
          description: 'Giày Jordan màu đỏ, size 41.',
          attributeValues: {'Màu': 'Red', 'Size': '41'},
        ),
        ProductVariationModel(
          id: '4',
          stock: 20,
          ...
          description: 'Giày Jordan màu xanh, size 42.',
          attributeValues: {'Màu': 'Blue', 'Size': '42'},
        ),
        ProductVariationModel(
          id: '5',
          stock: 10,
          price: 150,
          image: TImages.productImage7,
          description: 'Giày Jordan màu đen, size 43.',
          attributeValues: {'Màu': 'Black', 'Size': '43'},
        ),
        ProductVariationModel(
          id: '6',
          stock: 10,
          ...
          description: 'Giày Jordan màu trắng đỏ, size 44.',
          attributeValues: {'Màu': 'White', 'Size': '44'},
        ),
        ProductVariationModel(
          id: '7',
          stock: 10,
          ...
          description: 'Giày Jordan màu cam, size 44.',
          attributeValues: {'Màu': 'Orange', 'Size': '44'},
        ),
        ProductVariationModel(
          id: '7',
          stock: 10,
          price: 150,
          image: TImages.productImage20,
          description: 'Giày Jordan màu cam, size 42.',
          attributeValues: {'Màu': 'Orange', 'Size': '42'},
        ),
      ],
      productType: 'ProductType.variable',
    ),
